...
### Final remark
 ...
 Note that the _Fresnel_Integrals_ folder is protected by different copyright. Please, read carefully the copyright file included in that folder. The full original content can be found [here](https://mathworks.com/matlabcentral/fileexchange/28765-fresnels-and-fresnelc). 
